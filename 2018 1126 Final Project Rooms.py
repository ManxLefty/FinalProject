...
make_place('entrancehalllook', 'The furniture is very outdated.')
make_place('pantry', 'Nothing but moldy food and a couple of mouse traps.')
make_place('pantrylook', 'Nothing of interest.')
make_place('closet', 'Moths fly around the closet, despite the strong stench of mothballs.')
...
make_place('dininghall', 'The table is already set. It looks like they were going to have a dinner party.')
...
make_place('stairssouth','The stairs are covered with dust and the walls are covered with cobwebs.')
